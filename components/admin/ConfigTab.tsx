...
export const ConfigTab: React.FC<ConfigTabProps> = ({ localConfig, setLocalConfig, userEmail }) => {
    ...
    const subTabs = [
        ...
        { id: 'hero_form', label: 'Formulari Hero', icon: 'calendar_month' }, // RENAMED
    ...
    return (
        <div className="animate-[fadeIn_0.3s_ease-out] pb-32">
            ...
            <div className="space-y-8">
                ...
                {/* --- HERO FORM TAB (BROWN) - UPDATED FOR DUAL MODE --- */}
                {activeSubTab === 'hero_form' && (
                        ...
                        <div className="bg-[#fffcf5] p-8 rounded-b-xl rounded-tr-xl shadow-sm border-l-4 border-[#8D6E63] border-t border-r border-b border-[#eecfc3]">
                            ...
                            <div className="mb-8">
                                ...
                                <div className="flex gap-4">
                                    <button 
                                        onClick={() => updateConfig('hero', 'formType', 'reservation')}
                                        className={`flex-1 py-4 px-2 rounded-lg border-2 text-sm font-bold uppercase tracking-wide flex flex-col items-center gap-2 transition-all ${currentFormType === 'reservation' ? 'bg-[#8D6E63] border-[#8D6E63] text-white shadow-md' : 'bg-white border-gray-200 text-gray-400 hover:border-[#8D6E63]/50'}`}
                                    >
                                        <span className="material-symbols-outlined text-2xl">restaurant</span>
                                        Reserva Taula
                                    </button>
                                    <button 
                                        onClick={() => updateConfig('hero', 'formType', 'contact')}
                                    ...
                                    <button 
                                        onClick={() => updateConfig('hero', 'formType', 'none')}
                                    ...
                                    <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm mt-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                            ...
                                            <div>
                                                ...
                                                <input value={localConfig.hero.formNameLabel} onChange={(e) => updateConfig('hero', 'formNameLabel', e.target.value)} className="w-full border border-gray-300 rounded px-3 py-2 text-sm mb-2 outline-none focus:border-[#8D6E63]" />
                                                <label className="block text-[9px] font-bold uppercase text-gray-400 mb-1">Text Interior (Placeholder)</label>
                                                <input value={localConfig.hero.formNamePlaceholder} onChange={(e) => updateConfig('hero', 'formNamePlaceholder', e.target.value)} className="w-full border border-gray-300 bg-gray-50 rounded px-3 py-2 text-sm text-gray-600 outline-none focus:border-[#8D6E63]" />
                                            </div>

                                            {/* PHONE */}
                                            <div>
                                                <label className="block text-[9px] font-bold uppercase text-gray-400 mb-1">Etiqueta Telèfon</label>
                                                <input value={localConfig.hero.formPhoneLabel} onChange={(e) => updateConfig('hero', 'formPhoneLabel', e.target.value)} className="w-full border border-gray-300 rounded px-3 py-2 text-sm mb-2 outline-none focus:border-[#8D6E63]" />
                                                <label className="block text-[9px] font-bold uppercase text-gray-400 mb-1">Text Interior (Placeholder)</label>
                                                <input value={localConfig.hero.formPhonePlaceholder} onChange={(e) => updateConfig('hero', 'formPhonePlaceholder', e.target.value)} className="w-full border border-gray-300 bg-gray-50 rounded px-3 py-2 text-sm text-gray-600 outline-none focus:border-[#8D6E63]" />
                                            </div>

                                            {/* PAX */}
                                            <div>
                                                <label className="block text-[9px] font-bold uppercase text-gray-400 mb-1">Etiqueta Persones</label>
                                                <input value={localConfig.hero.formPaxLabel} onChange={(e) => updateConfig('hero', 'formPaxLabel', e.target.value)} className="w-full border border-gray-300 rounded px-3 py-2 text-sm mb-2 outline-none focus:border-[#8D6E63]" />
                                                <label className="block text-[9px] font-bold uppercase text-gray-400 mb-1">Text Interior (Ex: 2)</label>
                                                <input value={localConfig.hero.formPaxPlaceholder} onChange={(e) => updateConfig('hero', 'formPaxPlaceholder', e.target.value)} className="w-full border border-gray-300 bg-gray-50 rounded px-3 py-2 text-sm text-gray-600 outline-none focus:border-[#8D6E63]" />
                                            </div>

                                            {/* NOTES */}
                                            <div>
                                                <label className="block text-[9px] font-bold uppercase text-gray-400 mb-1">Etiqueta Notes</label>
                                                <input value={localConfig.hero.formNotesLabel} onChange={(e) => updateConfig('hero', 'formNotesLabel', e.target.value)} className="w-full border border-gray-300 rounded px-3 py-2 text-sm mb-2 outline-none focus:border-[#8D6E63]" />
                                                <label className="block text-[9px] font-bold uppercase text-gray-400 mb-1">Text Interior (Placeholder)</label>
                                                <input value={localConfig.hero.formNotesPlaceholder} onChange={(e) => updateConfig('hero', 'formNotesPlaceholder', e.target.value)} className="w-full border border-gray-300 bg-gray-50 rounded px-3 py-2 text-sm text-gray-600 outline-none focus:border-[#8D6E63]" />
                                            </div>

                                            {/* DATE & PRIVACY (SINGLE ROW) */}
                                            <div>
                                                <label className="block text-[9px] font-bold uppercase text-gray-400 mb-1">Etiqueta Data</label>
                                                <input value={localConfig.hero.formDateLabel} onChange={(e) => updateConfig('hero', 'formDateLabel', e.target.value)} className="w-full border border-gray-300 rounded px-3 py-2 text-sm outline-none focus:border-[#8D6E63]" />
                                            </div>
                                            <div>
                                                <label className="block text-[9px] font-bold uppercase text-gray-400 mb-1">Text Privacitat</label>
                                                <input value={localConfig.hero.formPrivacyLabel} onChange={(e) => updateConfig('hero', 'formPrivacyLabel', e.target.value)} className="w-full border border-gray-300 rounded px-3 py-2 text-sm outline-none focus:border-[#8D6E63]" />
                                            </div>
                                            <div>
                                                <label className="block text-[9px] font-bold uppercase text-gray-400 mb-1">Text "O truca'ns"</label>
                                                <input value={localConfig.hero.formCallUsLabel} onChange={(e) => updateConfig('hero', 'formCallUsLabel', e.target.value)} className="w-full border border-gray-300 rounded px-3 py-2 text-sm outline-none focus:border-[#8D6E63]" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-8 animate-[fadeIn_0.3s_ease-out]">
                                    ...
                                    <div className="bg-white border border-gray-200 rounded-lg p-6 space-y-6 shadow-sm">
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            <div>
                                                <label className="block text-[10px] font-bold uppercase text-gray-400 mb-1">Títol Formulari</label>
                                                <input value={localConfig.hero.heroContactTitle || "Contacta'ns"} onChange={(e) => updateConfig('hero', 'heroContactTitle', e.target.value)} className="w-full border border-gray-300 rounded px-4 py-3 text-sm text-gray-700 outline-none focus:border-[#8D6E63]" />
                                            </div>
                                            <div>
                                                <label className="block text-[10px] font-bold uppercase text-gray-400 mb-1">Subtítol</label>
                                                <input value={localConfig.hero.heroContactSubtitle || "Envia'ns un missatge"} onChange={(e) => updateConfig('hero', 'heroContactSubtitle', e.target.value)} className="w-full border border-gray-300 rounded px-4 py-3 text-sm text-gray-700 outline-none focus:border-[#8D6E63]" />
                                            </div>
                                            <div>
                                                <label className="block text-[10px] font-bold uppercase text-gray-400 mb-1">Text Botó Enviar</label>
                                                <input value={localConfig.hero.heroContactBtnText || "Enviar"} onChange={(e) => updateConfig('hero', 'heroContactBtnText', e.target.value)} className="w-full border border-gray-300 rounded px-4 py-3 text-sm font-bold text-[#8D6E63] outline-none focus:border-[#8D6E63]" />
                                            </div>
                                        </div>
                                    ...
                                    <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm mt-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                            ...
                                            <div>
                                                ...
                                                <input value={localConfig.hero.formEmailLabel} onChange={(e) => updateConfig('hero', 'formEmailLabel', e.target.value)} className="w-full border border-gray-300 rounded px-3 py-2 text-sm mb-2 outline-none focus:border-[#8D6E63]" />
                                                <label className="block text-[9px] font-bold uppercase text-gray-400 mb-1">Text Interior (Placeholder)</label>
                                                <input value={localConfig.hero.formEmailPlaceholder} onChange={(e) => updateConfig('hero', 'formEmailPlaceholder', e.target.value)} className="w-full border border-gray-300 bg-gray-50 rounded px-3 py-2 text-sm text-gray-600 outline-none focus:border-[#8D6E63]" />
                                            </div>
                                            ...
                                            <div className="lg:col-span-3">
                                                ...
                                                <input value={localConfig.hero.formMessageLabel} onChange={(e) => updateConfig('hero', 'formMessageLabel', e.target.value)} className="w-full border border-gray-300 rounded px-3 py-2 text-sm mb-2 outline-none focus:border-[#8D6E63]" />
                                                <label className="block text-[9px] font-bold uppercase text-gray-400 mb-1">Text Interior (Placeholder)</label>
                                                <input value={localConfig.hero.formMessagePlaceholder} onChange={(e) => updateConfig('hero', 'formMessagePlaceholder', e.target.value)} className="w-full border border-gray-300 bg-gray-50 rounded px-3 py-2 text-sm text-gray-600 outline-none focus:border-[#8D6E63]" />
                                            </div>
